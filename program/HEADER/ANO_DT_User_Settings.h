...
extern uint32_t P_liu , I_Liu , D_Liu ;
...
// -----指定各按钮事件-----7
//加速度计校准按钮
#define ANO_DT_ACCELEROMETER_ADJUSTING()	Stop_flag = !Stop_flag;//SysFlag.Error = !SysFlag.Error;

//陀螺仪校准按钮
#define ANO_DT_GYRO_CALIBRATED()			;//printf("gyro_adj\r\n");

//气压计校准按钮
#define ANO_DT_BAROMETER_CALIBRATED()		Global_Target_X = 0;//printf("barometer_adj\r\n");

//罗盘校准按钮
#define ANO_DT_COMPASS_CALIBRATED()			Global_Target_X = 1000;//printf("compass_adj\r\n");
...
#define PID_01_P    Global_Target_X
#define PID_01_I    Global_Target_Y
#define PID_01_D    Global_Target_Angle
#endif

#if defined(USE_PID_02)
#define PID_02_P    P_liu
#define PID_02_I    I_Liu
#define PID_02_D    D_Liu
#endif
